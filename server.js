...
var sessionConfig = require('./config/config.json')['fontEnd'].sessionConfig;
var redisConfig = require('./config/config.json')['fontEnd'].redis;
...
var queryRoutes = require('./server/routes/query');
...
const port = config.port || process.env.PORT || 443;
app.listen(port, () => {
